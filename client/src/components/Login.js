  ...
  render() {
    ...
    return (
      <div className="login-container">
        {auth && auth.error && auth.error !== "" && (
          <span className="error-text small alert-danger">{auth.error}!!!</span>
        )}
        <div
                  ...
                  <InputAdornment position="end">
                    ...
                    >
                      {this.state.showPassword ? (
                        ...
                        <Visibility className={classnames(classes.iconfield)} />
                      )}
                    </IconButton>
                  </InputAdornment>
                )
